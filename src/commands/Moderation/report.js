...
exports.info = {
  ...
  description: 'Reports a user, same thing as warn but just logs a message in the mod-logs channel. If you would like to let the bot keep logs of moderations create a text channel named `mod_logs`'
}
